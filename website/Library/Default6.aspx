<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="Default6.aspx.cs" Inherits="Default6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    Width="400px" DefaultMode="Insert" CssClass="mytable">
        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="Year" SortExpression="Year">
                ...
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox23" runat="server" Text='<%# Bind("Year") %>' 
                    Width="150px"></asp:TextBox>
                </InsertItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Publication" SortExpression="Publication">
                <EditItemTemplate>
                    ...
                    ControlToValidate="DropDownList13" Display="Dynamic" 
                    ErrorMessage="please select a topic" Font-Bold="True" Operator="NotEqual" 
                    ValueToCompare="-1">(*)</asp:CompareValidator>
                </EditItemTemplate>
                <InsertItemTemplate>
            ...
            <asp:TemplateField HeaderText="count" SortExpression="count">
                ...
                <InsertItemTemplate>
                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("count") %>' 
                        Width="150px"></asp:TextBox>
                </InsertItemTemplate>
                <ItemTemplate>
    ...
    SelectCommand="SELECT [TopicID], [TopicName] FROM [Topic]"></asp:SqlDataSource>
    ...
    SelectCommand="SELECT [BookID], [BookName], [Topic], [Autors], [Year], [Publication], [count] FROM [Book]" 
